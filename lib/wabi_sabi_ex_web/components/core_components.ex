defmodule WabiSabiExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(WabiSabiExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(WabiSabiExWeb.Gettext, "errors", msg, opts)
    end
  end
